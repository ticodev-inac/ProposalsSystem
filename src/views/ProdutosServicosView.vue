                ...
                <div class="modal-body">
                    ...
                    <div class="categories-list">
                        ...
                        <div v-if="filteredCategories.length === 0" class="empty-categories">
                            ...
                            {{ categoryTab === 'produto' ? 'produto' : 'serviço' }} encontrada
                        </div>
                    </div>
                </div>
            </div>
        ...
        setup() {
            ...
            const filterProducts = () => {
                ...
                if (selectedProductCategory.value) {
                    filtered = filtered.filter(
                        (product) => product.category === selectedProductCategory.value
                    )
                }
            ...
            const filterServices = () => {
                ...
                if (selectedServiceCategory.value) {
                    filtered = filtered.filter(
                        (service) => service.category === selectedServiceCategory.value
                    )
                }
