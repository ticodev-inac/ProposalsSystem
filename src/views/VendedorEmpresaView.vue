      ...
      <div v-else class="suppliers-list">
        <div v-for="supplier in filteredSuppliers" :key="supplier.id" class="supplier-card">
          <div class="supplier-info">
            ...
            <p><strong>Nome do Contato:</strong> {{ supplier.contact_name || 'Não informado' }}</p>
            <p><strong>CNPJ:</strong> {{ formatCNPJ(supplier.cnpj) }}</p>
            <p><strong>Email:</strong> {{ supplier.email || 'Não informado' }}</p>
            <p><strong>Telefone:</strong> {{ formatPhone(supplier.phone) || 'Não informado' }}</p>
            <p><strong>Cargo:</strong> {{ supplier.contact_position || 'Não informado' }}</p>
