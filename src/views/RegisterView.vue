    ...
    <div class="auth-card">
      ...
      <form @submit.prevent="onSubmit">
        <div class="form-group">
          ...
          <input id="email" type="email" v-model="email" required placeholder="seuemail@exemplo.com" />
        </div>

        <div class="form-group">
          <label for="password">Senha</label>
          <input id="password" type="password" v-model="password" required minlength="6" placeholder="Mínimo 6 caracteres" />
        </div>
