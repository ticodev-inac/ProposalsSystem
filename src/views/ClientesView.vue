            ...
            <div class="modal-content" @click.stop>
                ...
                <form @submit.prevent="saveClient" class="client-form">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="endereco" v-model="currentClient.address" />
                    </div>

                    <div class="form-row">
                        <div class="form-group">
                            <label for="cidade">Cidade</label>
                            <input type="text" id="cidade" v-model="currentClient.city" />
                        </div>
                        <div class="form-group">
            ...
            <div class="modal-content" @click.stop>
                ...
                <div class="client-details" v-if="viewingClient">
                    ...
                    <div
                        ...
                        v-if="viewingClient.contact_name || viewingClient.contact_position"
                    >
    ...
    export default {
        ...
        setup() {
            ...
            const checkCNPJExists = async (cnpj, excludeId = null) => {
                ...
                try {
                    let query = supabase.from('clients').select('id').eq('cnpj', cnpj)
            ...
            const isValidCNPJ = (cnpj) => {
                ...
                return (
                    parseInt(cnpj.charAt(12)) === digito1 && parseInt(cnpj.charAt(13)) === digito2
                )
            }
