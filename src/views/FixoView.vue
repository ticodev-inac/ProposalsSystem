            ...
            <div v-if="activeTab === 'politica'" class="tab-content">
                ...
                <div class="form-container">
                    <div class="form-section">
                        ...
                        <div
                            v-for="(secao, index) in politicaSections"
                            :key="secao.id"
                ...
                <div class="form-container">
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            >
                                <option value="">
                                    Selecione ou use o campo personalizado acima
                                </option>
    ...
    export default {
        ...
        setup() {
                ...
                try {
                    ...
                    if (condicoes) {
                        const dadosCondicoes =
                            typeof condicoes === 'string' ? JSON.parse(condicoes) : condicoes
                        condicoesForm.value = { ...condicoesForm.value, ...dadosCondicoes }
                    }

                    if (politica) {
                        const dadosPolitica =
                            typeof politica === 'string' ? JSON.parse(politica) : politica
                    ...
                    if (pagamento) {
                        const dadosPagamento =
                            typeof pagamento === 'string' ? JSON.parse(pagamento) : pagamento
            ...
            const salvarPolitica = async () => {
                try {
                    saving.value = true
                    await FixoService.savePoliticaContratacao(
                        JSON.stringify(politicaSections.value)
                    )
