<template>
    <div class="itens-page">
        <!-- Header Padronizado -->
        <HeaderProposal title="Itens" subtitle="Adicione produtos e serviços ao catálogo" />
        ...
        <div class="itens-grid">
            ...
            <div v-else-if="filteredItens.length === 0" class="no-data">Nenhum item encontrado</div>

            <div v-else>
                <div v-for="item in filteredItens" :key="item.id" class="grid-row">
                    ...
                    <form @submit.prevent="saveService">
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input
                                    v-model.number="serviceForm.min_price"
                                    type="number"
                                    step="0.01"
                                    min="0"
                                />
                            ...
                            <div class="form-group">
                                ...
                                <input
                                    v-model.number="serviceForm.max_price"
                                    type="number"
                                    step="0.01"
                                    min="0"
                                />
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input
                                    v-model.number="serviceForm.duration_hours"
                                    type="number"
                                    step="0.5"
                                    min="0"
                                />
            ...
            const filterItens = () => {
                ...
                if (selectedSpecificCategory.value) {
                    const catName = categories.value.find(
                        (cat) => cat.id === selectedSpecificCategory.value
                    )?.name
