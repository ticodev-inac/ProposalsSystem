        ...
        <div class="stats-grid">
            ...
            <div class="stat-card">
                ...
                <div class="stat-content">
                    ...
                    <span class="stat-number" id="propostasCount">
                        {{ stats.propostas || '--' }}
                    </span>
                </div>
            </div>
            ...
            <div class="stat-card">
                ...
                <div class="stat-content">
                    ...
                    <span class="stat-number" id="valorTotal">
                        {{ formatCurrency(stats.valorTotal) || 'R$ --' }}
                    </span>
                </div>
            </div>
        </div>
            ...
            <div class="status-grid">
                <div class="status-card status-draft">
                    ...
                    <div class="status-content">
                        <span class="status-number" id="rascunhoCount">
                ...
                <div class="status-card status-open">
                    ...
                    <div class="status-content">
                        <span class="status-number" id="abertoCount">
                            {{ statusCounts.aberto || '--' }}
                        </span>
                ...
                <div class="status-card status-negotiation">
                    ...
                    <div class="status-content">
                        <span class="status-number" id="negociacaoCount">
                ...
                <div class="status-card status-closed">
                    ...
                    <div class="status-content">
                        <span class="status-number" id="fechadoCount">
                ...
                <div class="status-card status-lost">
                    ...
                    <div class="status-content">
                        <span class="status-number" id="perdemosCount">
                            {{ statusCounts.perdemos || '--' }}
                        </span>
...
<script setup>
    ...
    const loadDashboardData = async () => {
        try {
            ...
            stats.value.valorTotal = (totalsRows || []).reduce(
                (acc, r) => acc + Number(r.total_geral || 0),
                0
            )

            // Status
            const { data: statusRows } = await supabase.from('proposals').select('status')
