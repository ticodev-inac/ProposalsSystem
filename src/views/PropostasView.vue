<template>
    <div class="propostas-page">
        ...
        <div class="proposals-grid" v-if="filteredProposals.length > 0">
            ...
            >
                ...
                <div class="proposal-info">
                    ...
                    <!-- Valor Total -->
                    <div
                        class="proposal-value-section"
                        v-if="proposal.total_amount || proposal.total_geral"
                    >
                        <div class="value-amount">
                            {{ formatCurrency(proposal.total_amount || proposal.total_geral) }}
                        </div>
        ...
        <div
            v-if="showItemModal"
            class="modal-overlay item-modal-overlay"
                            ...
                            <div class="item-info">
                                ...
                                <div class="item-details">
                                    <span
                                        class="badge"
                                        :class="
                                            item.type === 'produto' ? 'badge-info' : 'badge-success'
                                        "
                                    >
                        ...
                        <p>
                            {{
                                availableItems.length === 0
                                    ? 'Carregando itens...'
                                    : itemSearchTerm || selectedItemType || selectedItemCategory
                                      ? 'Nenhum item encontrado com os filtros aplicados'
                                      : 'Todos os itens disponíveis estão listados acima'
                            }}
                        </p>
                    </div>
        ...
        <div
            ...
            class="modal-overlay supply-modal-overlay"
            @click.self="onOverlayClick"
        >
            <div class="modal-content large-modal" @click.stop>
                <div class="modal-header">
                    <h5>
                        {{ editingSupplyIndex !== null ? 'Editar Insumo' : 'Selecionar Insumos' }}
                    </h5>
                        ...
                        >
                            <div class="item-info">
                                ...
                                <div class="item-details">
                                    ...
                                    <span v-if="supply.unit" class="item-unit">
                                        {{ supply.unit }}
                                    </span>
                                </div>
                            </div>
        ...
        <div
            v-if="showOptionalModal"
            class="modal-overlay optional-modal-overlay"
            @click.self="onOverlayClick"
        >
                            ...
                            {{
                                availableOptionals.length === 0
                                    ...
                                    : optionalSearchTerm ||
                                      ...
                                      ? 'Nenhum opcional encontrado com os filtros aplicados'
                                      : 'Todos os opcionais disponíveis estão listados acima'
                            }}
                        </p>
                    </div>
                ...
                <div class="modal-content">
                                    ...
                                    <div class="item-details">
                                        <div class="item-details">
                                            ...
                                            <div class="price-edit">
                                                ...
                                                <span
                                                    v-if="
                                                        insumo.preco_base != null &&
                                                        Number(insumo.preco_base) !==
                                    ...
                                    <div class="item-details">
                                        <div class="item-details">
                                            ...
                                            <div class="price-edit">
                                                ...
                                                <span
                                                    v-if="
                                                        opcional.preco_base != null &&
                                                        Number(opcional.preco_base) !==
                        ...
                        <div class="totals-section">
                            ...
                            <div class="totals-breakdown">
                                <div class="breakdown-item" v-if="totals.produtos > 0">
                                    <div class="breakdown-info">
                                        <span class="breakdown-label">
                                            Produtos ({{ counts.produtos }} itens)
                                        </span>
                                ...
                                <div class="breakdown-item" v-if="totals.servicos > 0">
                                    <div class="breakdown-info">
                                        <span class="breakdown-label">
                                            Serviços ({{ counts.servicos }} itens)
                                        </span>
                                        <span class="breakdown-value">
                                ...
                                <div class="breakdown-item" v-if="totals.opcionais > 0">
                                    <div class="breakdown-info">
                                        <span class="breakdown-label">
                                            ...
                                            <span v-if="!incluirOpcionais" class="excluded-note">
                                                - não incluído
                                            </span>
                                        </span>
                                        <span
                                            class="breakdown-value"
                                            :class="{ excluded: !incluirOpcionais }"
                                        >
                                ...
                                <div class="breakdown-item">
                                    <div class="breakdown-info">
                                        ...
                                        <span
                                            class="breakdown-value negative"
                    ...
                    <div v-if="activeTab === 'conditions'" class="tab-pane">
                        ...
                        <div v-if="condicoesGerais" class="conditions-content">
                            <div class="config-section">
                                ...
                                <div class="config-item" v-if="condicoesGerais.condicoesEspeciais">
                                    ...
                                    <div class="config-value text-content">
                                        {{ condicoesGerais.condicoesEspeciais }}
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div v-else class="empty-section">
                            ...
                            <p class="help-text">
                                Configure as condições gerais na tela de
                    ...
                    <div v-if="activeTab === 'supplier'" class="tab-pane">
                        ...
                        <div class="supplier-selection">
                            ...
                            <div v-if="selectedSupplier" class="supplier-details">
                                <div class="supplier-card">
                                    ...
                                    <div class="supplier-info">
                                        ...
                                        <div
                                            class="info-row"
                                            v-if="selectedSupplier.contact_person"
                                        >
                            ...
                            <div v-if="!selectedSupplier" class="supplier-help">
                                ...
                                <p>
                                    Selecione um fornecedor para finalizar a proposta. Esta será a
...
<script>
    ...
    export default {
        ...
        setup() {
            ...
            const { generateAndDownloadPDF, isGenerating, generationError, clearError } =
                usePDFGenerator()
      ...
      `
            ...
            const normalizeRows = (rows) => {
                ;(rows || []).forEach((r) => {
                    ...
                    if (r.preco_base == null)
                        r.preco_base = Number(r.valor_unitario ?? r.price ?? 0)
            ...
            const openEditModal = async (proposal) => {
                ...
                try {
                    form.value.insumos = proposal.insumos
                        ? typeof proposal.insumos === 'string'
                            ? JSON.parse(proposal.insumos)
                            : proposal.insumos
                        : []
                } catch (e) {
                    form.value.insumos = []
                ...
                try {
                    form.value.opcionais = proposal.opcionais
                        ? typeof proposal.opcionais === 'string'
                            ? JSON.parse(proposal.opcionais)
                            : proposal.opcionais
                        : []
                } catch (e) {
                    ...
                    if (proposal.condicoes_gerais) {
                        condicoesGerais.value =
                            typeof proposal.condicoes_gerais === 'string'
                                ? JSON.parse(proposal.condicoes_gerais)
                ...
                try {
                    politicas.value = proposal.politicas
                        ? typeof proposal.politicas === 'string'
                            ? JSON.parse(proposal.politicas)
                            : proposal.politicas
                        : []
                } catch (e) {
                    politicas.value = []
            ...
            const saveProposal = async () => {
                try {
                    ...
                    if (!form.value.proposal_number && form.value.client_id) {
                        form.value.proposal_number = await getNextProposalNumber(
            ...
            const updateAvailableCategories = () => {
                ...
                const itemsOfSelectedType = availableItems.value.filter(
                    (item) => item.type === selectedItemType.value
                )

                // Extrair categorias únicas dos itens filtrados
                const uniqueCategories = [
                    ...new Set(itemsOfSelectedType.map((item) => item.category_name)),
                ]
            ...
            const filterAvailableItems = () => {
                ...
                if (selectedItemCategory.value) {
                    filtered = filtered.filter(
                        (item) => item.category_name === selectedItemCategory.value
                    )
                }
            ...
            const toggleSupplySelection = (supply) => {
                const index = selectedSupplies.value.findIndex(
            ...
            const updateAvailableOptionalCategories = () => {
                ...
                const optionalsOfSelectedType = availableOptionals.value.filter(
                    (optional) => optional.type === selectedOptionalType.value
                )

                // Extrair categorias únicas dos opcionais filtrados
                const uniqueCategories = [
                    ...new Set(optionalsOfSelectedType.map((optional) => optional.category_name)),
                ]
            ...
            const filterAvailableOptionals = () => {
                ...
                if (selectedOptionalCategory.value) {
                    filtered = filtered.filter(
                        (optional) => optional.category_name === selectedOptionalCategory.value
                    )
                }
                    ...
                    filtered = filtered.filter(
                        (optional) =>
                            ...
                            (optional.description &&
                                optional.description.toLowerCase().includes(term)) ||
            ...
            const isOptionalSelected = (optional) => {
                return selectedOptionals.value.some(
                    (selected) => selected.id === optional.id && selected.type === optional.type
                )
            }

            const toggleOptionalSelection = (optional) => {
                const index = selectedOptionals.value.findIndex(
                    (selected) => selected.id === optional.id && selected.type === optional.type
                )
...
<style scoped>
    ...
    .modal .modal-body {
        /* <- antes estava .modal > .modal-body (não pegava) */
        flex: 1 1 auto;
