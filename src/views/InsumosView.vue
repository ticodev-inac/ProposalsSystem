<template>
    <div class="insumos-page">
        <!-- Header Padronizado -->
        <HeaderProposal title="Insumos" subtitle="Adicione materiais, mão de obra e equipamentos">
            <template #actions>
        ...
        <div class="search-section">
            ...
            <div class="filters">
                <select v-model="selectedType" @change="filterInsumos">
                    ...
                    <option v-for="type in availableTypes" :key="type.id" :value="type.name">
        ...
        <div class="insumos-grid">
            ...
            <div v-else>
                <div v-for="insumo in filteredInsumos" :key="insumo.id" class="grid-row">
                    ...
                    <form @submit.prevent="saveInsumo">
                        ...
                        <div class="form-group">
                            ...
                            <small class="char-counter">
                                {{ currentInsumo.descricao?.length || 0 }}/500
                            </small>
                        </div>
                    ...
                    <div class="new-type-form">
                        ...
                        <form @submit.prevent="createNewType">
                            ...
                            <button type="submit" class="btn btn-primary" :disabled="creatingType">
                                <i
                                    class="fa-solid"
                                    :class="creatingType ? 'fa-spinner fa-spin' : 'fa-plus'"
                                ></i>
                            ...
                            <div v-for="type in availableTypes" :key="type.id" class="type-item">
                                ...
                                <div v-else class="type-info">
                                    ...
                                    <div class="type-details">
                                        ...
                                        <small v-if="type.description">
                                            {{ type.description }}
                                        </small>
                                        <small class="usage-count">
                                            ({{ getTypeUsageCount(type.name) }} insumos)
                                        </small>
                                    </div>
                                    <div class="type-actions">
                                        ...
                                        <button
                                            v-if="
                                                !isDefaultType(type.name) &&
                                                getTypeUsageCount(type.name) === 0
                                            "
    ...
    export default {
        ...
        setup() {
            ...
            const insumosSubtotal = computed(() => {
                return selectedInsumos.value.reduce(
          ...
          `
            ...
            const saveInsumo = async () => {
                try {
                    ...
                    // tipo selecionado
                    const selectedTypeObj = availableTypes.value.find(
                        (t) => t.name === currentInsumo.value.tipo
                    )
                    ...
                    if (showEditModal.value) {
                        ...
                        const { error } = await supabase.from('supplies').insert([insumoData])
                        if (error) throw error
                    }
