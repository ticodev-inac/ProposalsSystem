            ...
            <p>
                {{
                    searchTerm
                        ...
                        : 'Crie seu primeiro modelo para agilizar a criação de propostas'
                }}
            </p>
            ...
            <div class="modal-content large-modal" @click.stop>
                ...
                <div class="modal-footer">
                    ...
                    <button
                        ...
                        :disabled="!modelForm.name || saving"
                    >
    ...
    export default {
        ...
        setup() {
            ...
            const filterModels = () => {
                ...
                filteredModels.value = models.value.filter(
                    (model) =>
            ...
            const updateAvailableCategories = () => {
                ...
                availableCategories.value = allCategories.value.filter(
                    (cat) => cat.type === selectedItemType.value
                )
            }
            ...
            const filterAvailableSupplies = () => {
                ...
                if (selectedSupplyType.value) {
                    filtered = filtered.filter(
                        (supply) => (supply.type || supply.tipo) === selectedSupplyType.value
                    )
                }
            ...
            const filterAvailableOptionals = () => {
                ...
                if (optionalSearchTerm.value) {
                    ...
                    filtered = filtered.filter(
                        (optional) =>
                            ...
                            (optional.description || optional.descricao || '')
                                .toLowerCase()
                                .includes(term)
                    )
                }
                ...
                if (selectedOptionalCategory.value) {
                    filtered = filtered.filter(
                        (optional) => optional.category === selectedOptionalCategory.value
                    )
                }
            ...
            const saveOptional = () => {
                ...
                if (editingOptionalIndex.value !== null) {
                    ...
                    modelForm.value.opcionais[editingOptionalIndex.value] = {
                        ...optionalForm.value,
                    }
                } else {
